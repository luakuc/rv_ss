...
VMM_OBJS	:= vmm/vcpu.o vmm/vmm.o vmm/enter.o vmm/mmu.o vmm/hfence.o vmm/test_guest.o vmm/trap.o vmm/plic_emu.o vmm/uart_emu.o vmm/inst_emu.o vmm/sbi_emu.o
